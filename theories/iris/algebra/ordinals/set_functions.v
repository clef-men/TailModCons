...
From iris.algebra.ordinals Require Import set_model set_sets.
...
- apply zf_replacement. exists p. split. apply zf_specification. split; eauto.
...
- apply zf_replacement. exists (x,y). split. eauto using res_opair. now rewrite pi2_cor.
...
Proof.
intros I [I' I'']. assert (F: function f A B). split; eauto. apply zf_extensionality; split; intros y J.
